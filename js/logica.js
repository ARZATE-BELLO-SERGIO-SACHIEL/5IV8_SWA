function XDE() {
	...
	var subredes = parseInt(document.getElementById('subred').value);
	...
	for (let index = 0; index < 4; index++) {
		...
		if ((clas2 == 0) && (contenido == 0)){
			ar2[index] = 0;
			
		}
		if ((clas2 == 0) && (contenido == 1)){
			ar2[index] = bitdec;
			contenido--;
		}
		if (clas2 != 0) {
	...
	for (let index = 0; index < con; index++) {
		...
		if (clas == 1) {
			primera = ipp[0] + "." + contenido + ".0" + ".0";
			contenido = contenido + rango;
			p1 = contenido;
			p1--;
		...
		if (clas == 2) {
			primera = ipp[0] + "." + ipp[1] + "." + contenido + ".0";
			contenido = contenido + rango;
			p1 = contenido;
			p1--;
		...
		if (clas == 3) {
			primera = ipp[0] + "." + ipp[1] + "." + ipp[2] + "." + contenido;
			contenido = contenido + rango;
			p1 = contenido;
			p1--;
